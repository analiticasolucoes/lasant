        ...
        <section class="content">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-wrench"></i> Planos de Manutenção</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-striped table-responsive">
                        ...
                        <tbody>
                        <?php /*
				$sql_consult2 = mysql_query("SELECT * FROM tb_plano_manutencao ORDER BY nm_plano ASC") or die (mysql_error());
...
$dt_inicio = date('d/m/Y', strtotime($dados['dt_inicio']));
$dt_termino = date('d/m/Y', strtotime($dados['dt_termino']));	

				*/ ?>
                        <tr>
                            <td><?php /* echo $dados['nm_plano'] */ ?></td>
                            ...
                            <td>
                                ...
                                <a href="ficha_plano.php?id=<?php /* echo $dados['id'] */ ?>"><button class="btn btn-sm btn-primary"><span class="fa fa-search"></span></button></a>
                                <?php /* } */ ?>
                            </td>
                            <td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <p>Tem certeza que deseja excluir o Plano <b><?php /* echo $dados['nm_plano'] */ ?></b> ?</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="delete_plano.php?id=<?php /* echo $dados['id'] */ ?>" class="btn btn-primary">Sim</a>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                            </div>
