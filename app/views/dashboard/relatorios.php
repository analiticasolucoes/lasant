            ...
            <form action="ir_relatorio.php" method="post" enctype="multipart/form-data" target="_blank">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><span class="fa fa-search"></span>Relatórios</h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="id_relatorio">Selecione o Relatório</label>
                                    <select class="form-control" id="id_relatorio" name="id_relatorio" required="required">
                                        <option value="" selected>Selecione</option>
                                        <?php /*
		$sql_cliente = mysql_query("SELECT * FROM ta_relatorios WHERE tipo_rel='4' ORDER BY nome_relatorio ASC") or die (mysql_error());
		while ($row_cliente = mysql_fetch_assoc($sql_cliente)) {
		*/ ?>
                                        <option value="<?php /* echo $row_cliente['id'] */ ?>"><?php /* echo $row_cliente['nome_relatorio'] */ ?></option>
                                        <?php /*
		}
		*/ ?>
                                    </select>
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary pull-right p-5"><span class="fa fa-search p-5"></span> Pesquisar</button>
                    </div>
                </div>
            </form>
        </section>
