...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="add_solicitacao_servico.php" method="post" enctype="multipart/form-data" target="_self">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-warning"></i> Cadastro Solicitação de Serviço</h3>
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="id_empresa">Situação</label>
                                    <select class="form-control" id="id_empresa" name="id_empresa" disabled>
                                        <?php /*
                                        $sql_situSS = mysql_query("SELECT * FROM ta_situacao_ss ORDER BY id ASC LIMIT 1") or die (mysql_error());
                                        $row_situSS = mysql_fetch_assoc($sql_situSS);
                                        */ ?>
                                        <option value="" selected><?php /* echo $row_situSS['ds_situacao'] */ ?></option>
                                    </select>
                                    <input type="hidden" value="<?php /* echo $row_situSS['id'] */ ?>" name="id_situacaoSS" />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="ds_servico">Descrição dos Serviços</label>
                                    <textarea rows="5" id="ds_servico" name="ds_servico" class="form-control" placeholder="Descrição dos Serviços" required="required"></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary pull-right">
                            <span class="fa fa-plus pe-2"></span>Adicionar
                        </button>
                    </div>
                </div>
                <!-- /.box -->
