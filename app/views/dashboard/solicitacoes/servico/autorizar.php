...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="aprovar_ss_lote_form.php" method="get" enctype="multipart/form-data" target="_self">
                <div class="box box-default">
                 ...
                 -->
                    ...
                    <div class="box-footer">
                        <a data-toggle="modal" data-target="#modal_aut_ss" class="btn btn-success pull-right"><span class="fa fa-thumbs-o-up"></span> Autorizar Solicitações</a>
            ...
            <?php /* if ($_GET['acao'] == "pesquisa") { */ ?>
                ...
                if($_GET['id_situacaoSS'] != "") { $b5 = "AND id_situacaoSS= 1"; }
                ...
                */ ?>
                ...
                <form action="autorizar_ss_lote.php<?php /* echo $variaveis */ ?>" method="post" enctype="multipart/form-data" target="_self">
                                ...
                                while ($dados = mysql_fetch_array($sql_consult2)) {
                                    ...
                                    */ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php /*
                                            if($_SESSION['operadorTipo'] == 2 and $dados['id_situacaoSS'] == 1) {
                                                */ ?>
                                                <input type="checkbox" name="aprovadas[]" value="<?php /*echo $dados['id'];*/ ?>">
                                                <?php /*
                                            }
                                            */ ?>
                                        </td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-green">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">×</span></button>
                                    <h4 class="modal-title">Aprovar Solicitações Selecionadas</h4>
                                </div>
                                <div class="modal-body">
